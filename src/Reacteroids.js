...
export class Reacteroids extends Component {
  ...
  startGame() {
    ...
    if (this.state.dataLoaded != true) {
      ...
      var apiUrl =
        "https://api.nasa.gov/neo/rest/v1/neo/browse?page=0" +
        "&orbiting_body=Earth" +
        "&api_key=" +
        apiKey;
      ...
      asteroidApiObj.then(asteroidApiObj => {
        ...
        var closeAppoachAsteroids = asteroidApiObj.near_earth_objects.filter(
          function(asteroid) {
        ...
        var mappedAsteroidData = closeAppoachAsteroids.map(function(asteroid) {
          ...
          return {
            ...
            sizeInKm: (sizeInKm.estimated_diameter_max +
              sizeInKm.estimated_diameter_min) /
              2,
